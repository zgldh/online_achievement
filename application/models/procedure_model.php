...
class Procedure_model extends MY_Model
{
    ...
    {
        $raw = $this->db->get_where ( Procedure_model::TABLE, array (
                ProcedurePeer::PK => $procedure_id 
        ) )->row_array ();
    ...
    public function getByAchievementID($achievement_id, $formation = false)
    {
        ...
        if ($formation)
        {
            ...
            $result = $this->db->get_where ( Procedure_model::TABLE, array (
