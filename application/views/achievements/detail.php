...
<div class="container-fluid detail-content">
    ...
    <div class="left-content row-fluid">
        ...
        <div class="right-content span9">
            ...
            <?php endif;?>
            	<div class="intent_status">
            		<span><i class="icon-thumbs-up"></i> {123}</span>
            		<span><i class="icon-thumbs-down"></i> {123}</span>
            		<a><i class="icon-comment"></i> {123}</a>
            	</div>
            </div>
        	<!-- 成就进度指示器 end -->
                    ...
                    <li>
                        ...
                        <div class="procedure-tools">
                            <div class="btn-group">
                            	...
                            	<button
			                        type="button" 
			                        class="btn btn-small procedure_tools_view_track_btn" 
			                        rel="tooltip" 
			                        data-original-title="看看别人是怎么完成的"><i class="icon-eye-open"></i></button>
                            </div>
            ...
            <div class="right-item">
                <ul id="intent_tab" class="nav nav-tabs">
                 	<li class="disabled"><i class="icon-big icon-flag"></i></li>
				    <li class="active"><a href="#intent_complete" data-toggle="tab">这些人完成了本成就</a></li>
				    <li><a href="#intent_processing" data-toggle="tab">这些人正在努力</a></li>
			    </ul>
			    <div class="tab-content">
	                <div id="intent_complete" class="tab-pane active">
	                ...
	                <div id="intent_processing" class="tab-pane">
